...
class DelecteTestScreen(tk.Frame):
    ...
    def init_widgets(self):    
        tk.Label(self, text="Selecciona el test que quieres eliminar",
                 justify=tk.CENTER,
        ...
        tk.Button(self, text= "Delete Test",
                  relief= tk.FLAT,
    ...
    def delete_test(self):
        ...
        tk.messagebox.showinfo(
            title = "SUCCESS",
            message = f"Haz eliminado {_test_name}")
