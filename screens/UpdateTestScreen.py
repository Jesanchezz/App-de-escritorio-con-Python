...
class UpdateTestScreen(tk.Frame):
    ...
    def init_widgets(self):    
        tk.Label(self, text="Selecciona el test a modificar",
                 justify=tk.CENTER,
                 **styles.STYLE).pack(**styles.PACK)
        
        self.options = SelectOption(self, self.manager, self.option_list)
        self.options.pack(**styles.PACK)


        tk.Label(self, text="Enunciado de la pregunta: ",
                 justify=tk.CENTER,
                 **styles.STYLE).pack(**styles.PACK)
        ...
        tk.Label(self, text="Escribe las respuestas separadas por ';': ",
                 justify=tk.CENTER,
                 **styles.STYLE).pack(**styles.PACK)
        ...
        tk.Label(self, text="Número de la respuesta correcta (empieza en 0): ",
                justify=tk.CENTER,
                **styles.STYLE).pack(**styles.PACK)
        
        final_input = tk.Entry(self, textvariable=self.correct_choice, 
                           justify = tk.CENTER,**styles.STYLE)
        final_input.pack(**styles.PACK)
